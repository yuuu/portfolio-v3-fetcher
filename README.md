...
- fetcher - Code for the application's Lambda function and Project Dockerfile.
...
```bash
portfolio-v3-fetcher$ ruby tests/unit/test_handler.rb
```
...
```bash
sam delete --stack-name portfolio-v3-fetcher
```
